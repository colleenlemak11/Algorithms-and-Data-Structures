...
# Plot the data
set title "ArraySeq vs Vector Insert Operation Performance";
plot  infile u 1:2 t "ArraySeq, Front" w linespoints lw 3 lc rgb RED pointtype 6, \
      infile u 1:3 t "Vector, Front" w linespoints lw 3 lc rgb GREEN pointtype 6, \
      infile u 1:4 t "ArraySeq, Middle" w linespoints lw 3 lc rgb YELLOW pointtype 6, \
      infile u 1:5 t "Vector, Middle" w linespoints lw 3 lc rgb BLUE pointtype 6, \
      infile u 1:6 t "ArraySeq, End" w linespoints lw 3 lc rgb ORANGE pointtype 6, \
      infile u 1:7 t "Vector, End" w linespoints lw 3 lc rgb PURPLE pointtype 6;
...
plot  infile u 1:8 t "ArraySeq, Front" w linespoints lw 3 lc rgb RED pointtype 6, \
      infile u 1:9 t "Vector, Front" w linespoints lw 3 lc rgb GREEN pointtype 6, \
      infile u 1:10 t "ArraySeq, Middle" w linespoints lw 3 lc rgb YELLOW pointtype 6, \
      infile u 1:11 t "Vector, Middle" w linespoints lw 3 lc rgb BLUE pointtype 6, \
      infile u 1:12 t "ArraySeq, End" w linespoints lw 3 lc rgb ORANGE pointtype 6, \
      infile u 1:13 t "Vector, End" w linespoints lw 3 lc rgb PURPLE pointtype 6;
...
plot  infile u 1:14 t "ArraySeq, Front" w linespoints lw 3 lc rgb RED pointtype 6, \
      infile u 1:15 t "Vector, Front" w linespoints lw 3 lc rgb GREEN pointtype 6, \
      infile u 1:16 t "ArraySeq, Middle" w linespoints lw 3 lc rgb YELLOW pointtype 6, \
      infile u 1:17 t "Vector, Middle" w linespoints lw 3 lc rgb BLUE pointtype 6, \
      infile u 1:18 t "ArraySeq, End" w linespoints lw 3 lc rgb ORANGE pointtype 6, \
      infile u 1:19 t "Vector, End" w linespoints lw 3 lc rgb PURPLE pointtype 6;
